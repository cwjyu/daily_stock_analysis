...
import { BarChart3, BriefcaseBusiness, CircleDollarSign, Home, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'gold', label: '黄金', to: '/gold', icon: CircleDollarSign },
