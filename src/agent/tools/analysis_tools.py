...
def _handle_analyze_trend(stock_code: str) -> dict:
    ...
    return {
        ...
        "bias_ma50": round(result.bias_ma50, 2),
        "bias_ma200": round(result.bias_ma200, 2),
        ...
        "bb_middle": round(result.bb_middle, 2),
        ...
        "adx_plus_di": round(result.adx_plus_di, 2),
        "adx_minus_di": round(result.adx_minus_di, 2),
